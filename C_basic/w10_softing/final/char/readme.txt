...
0. data.c và data.h : định nghĩa kiểu data_t là kiểu kí tự (char) và các thao tác cơ bản trên nó (swap, showData)
...
2. main.c: chương trình minh họa cách sử dụng thư viện sort, với kiểu dữ liệu cơ bản dạng kí tự (char)
